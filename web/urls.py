...
urlpatterns = [
    ...
    path("tier/<str:slug>/", views.mealcategory_detail, name="mealcategory_detail"),
    path("plan/<str:pk>/", views.subscriptionplan_detail, name="subscriptionplan_detail"),
    ...
    path("customize/", views.customize_menu, name="customize_menu"),
